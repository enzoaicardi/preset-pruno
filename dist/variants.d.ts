...
import { presetPrunoOptions } from './index.js';
...
declare function variantColorsMediaOrClass(options?: presetPrunoOptions): Variant[];

declare const variantDataAttribute: VariantObject;

declare function variants(options: presetPrunoOptions): Variant<Theme>[];
...
declare function variantTaggedPseudoClasses(options?: presetPrunoOptions): VariantObject[];
