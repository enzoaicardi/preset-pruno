...
interface presetPrunoOptions extends PresetOptions {
    /**
     * Dark mode options
     *
     * @default 'class'
...
declare function presetPruno(options?: presetPrunoOptions): Preset<Theme>;
...
export { DarkModeSelectors, presetPrunoOptions, VarPrefixPostprocessor, presetPruno as default, normalizePreflights, preflights, presetPruno };
